...
export const getRoutineUserProgress = (id) =>
	api.get(`${BASE_ADMIN}/routine/getAllUserProgresses/${id}`);
export const getAdminRoutineProgressSummary = () =>
	api.get(`${BASE_ADMIN}/routine/getAdminRoutineProgressSummary`);

// User APIs
export const joinRoutine = (routineId) =>
	api.post(`${BASE_USER}/routine/joinRoutine/${routineId}`);
export const getRoutineProgress = (routineId) =>
	api.get(`${BASE_USER}/routines/getRoutineProgress/${routineId}`);
export const getAllRoutineProgress = () =>
	api.get(`${BASE_USER}/routines/getAllRoutineProgress`);
export const changeCompletionStatus = (routineId, weekId, dayId) =>
	api.post(`${BASE_USER}/routine/${routineId}/${weekId}/${dayId}/true`);

// Public APIs
export const getRoutine = (routineId) =>
	api.get(`${BASE_PUBLIC}/getRoutine/${routineId}`);
